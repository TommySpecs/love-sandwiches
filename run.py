...
def get_sales_data():
    ...
    by commas. The loop repeatedly requests data, until it is valid.
    """
    while True:
...
def calculate_surplus_data(sales_row):
    ...
    The surplusis defined as the sale figure subtracted from the stock:
...
def get_last_5_enteries_sales():
    ...
    the last 5 enteries for each sandwich and return the data as a list of lists.
    """
...
def calculate_stock_data(data):
    """
    Calculate the average stocl for each item, adding 10%
    """
